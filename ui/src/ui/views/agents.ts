    ...
    return [
        {
            ...
            label: t("agentsFiles"),
            tools: [
                {id: "read", label: "read", description: t("agentsReadFile")},
                {id: "write", label: "write", description: t("agentsWriteFile")},
                {id: "edit", label: "edit", description: t("agentsEdit")},
                {id: "apply_patch", label: "apply_patch", description: t("agentsApplyPatch")},
            ],
        },
        {
            id: "runtime",
            label: t("agentsRuntime"),
            tools: [
                {id: "exec", label: "exec", description: t("agentsExec")},
                {id: "process", label: "process", description: t("agentsProcess")},
            ],
        },
        {
            id: "web",
        ...
        {
            id: "sessions",
            label: t("agentsSessions"),
            tools: [
                {id: "sessions_list", label: "sessions_list", description: t("agentsSessionsList")},
                {
                    id: "sessions_history",
                    label: "sessions_history",
                    description: t("agentsSessionsHistory"),
                },
                {id: "sessions_send", label: "sessions_send", description: t("agentsSessionsSend")},
                {id: "sessions_spawn", label: "sessions_spawn", description: t("agentsSessionsSpawn")},
                {id: "session_status", label: "session_status", description: t("agentsSessionStatus")},
            ],
        },
        {
            id: "ui",
            label: t("agentsUi"),
            tools: [
                {id: "browser", label: "browser", description: t("agentsBrowser")},
                {id: "canvas", label: "canvas", description: t("agentsCanvas")},
            ],
        },
        {
            id: "messaging",
            label: t("agentsMessaging"),
            tools: [{id: "message", label: "message", description: t("agentsMessage")}],
        },
        {
            id: "automation",
            label: t("agentsAutomation"),
            tools: [
                {id: "cron", label: "cron", description: t("agentsScheduleTasks")},
                {id: "gateway", label: "gateway", description: t("agentsGatewayControl")},
            ],
        },
        {
            id: "nodes",
            label: t("agentsNodes"),
            tools: [{id: "nodes", label: "nodes", description: t("agentsNodesDevices")}],
        },
        {
            id: "agents",
            label: t("agentsAgents"),
            tools: [{id: "agents_list", label: "agents_list", description: t("agentsListAgents")}],
        },
        {
            id: "media",
            label: t("agentsMedia"),
            tools: [{id: "image", label: "image", description: t("agentsImageUnderstanding")}],
        },
    ];
}
...
function getProfileOptions() {
    return [
        {id: "minimal", label: t("agentsProfileMinimal")},
        {id: "coding", label: t("agentsProfileCoding")},
        {id: "messaging", label: t("agentsProfileMessaging")},
        {id: "full", label: t("agentsProfileFull")},
    ] as const;
}
...
function agentBadgeText(agentId: string, defaultId: string | null) {
    return defaultId && agentId === defaultId ? t("agentsDefault") : null;
}
...
function buildModelOptions(configForm: Record<string, unknown> | null, current?: string | null) {
    ...
    if (current && !hasCurrent) {
        options.unshift({value: current, label: `${t("agentsCurrentModel")} (${current})`});
    }
    if (options.length === 0) {
        return html`
        ...
        <div class="agents-layout">
            <section class="card agents-sidebar">
                <div class="row" style="justify-content: space-between;">
                    <div>
                        <div class="card-title">${t("agentsTitle")}</div>
                        <div class="card-sub">${agents.length} ${t("agentsConfigured")}</div>
                    </div>
                ...
                <div class="agent-list" style="margin-top: 12px;">
                    ${
                            agents.length === 0
                                    ? html`
                                        <div class="muted">${t("agentsNoFound")}</div>
                                    `
                                    : agents.map((agent) => {
            ...
            <section class="agents-main">
                ${
                        !selectedAgent
                                ? html`
                                    <div class="card">
                                        <div class="card-title">${t("agentsSelectAgent")}</div>
                                        <div class="card-sub">${t("agentsSelectAgentSub")}</div>
                                    </div>
                                `
                                : html`
                                    ${renderAgentHeader(
...
function renderAgentHeader(
    ...
    const subtitle = agent.identity?.theme?.trim() || t("agentsWorkspaceRouting");
...
function renderAgentTabs(active: AgentsPanel, onSelect: (panel: AgentsPanel) => void) {
    const tabs: Array<{ id: AgentsPanel; label: string }> = [
        {id: "overview", label: t("agentsTabOverview")},
        {id: "files", label: t("agentsTabFiles")},
        {id: "tools", label: t("agentsTabTools")},
        {id: "skills", label: t("agentsTabSkills")},
        {id: "channels", label: t("agentsTabChannels")},
        {id: "cron", label: t("agentsTabCron")},
    ];
    return html`
...
function renderAgentOverview(params: {
    ...
    return html`
        <section class="card">
            <div class="card-title">${t("agentsOverview")}</div>
            <div class="card-sub">${t("agentsOverviewSub")}</div>
            <div class="agents-overview-grid" style="margin-top: 16px;">
                <div class="agent-kv">
                    <div class="label">${t("agentsWorkspace")}</div>
                    <div class="mono">${workspace}</div>
                </div>
                <div class="agent-kv">
                    <div class="label">${t("agentsPrimaryModel")}</div>
                    <div class="mono">${model}</div>
                </div>
                <div class="agent-kv">
                    <div class="label">${t("agentsIdentityName")}</div>
                    <div>${identityName}</div>
                    ${identityStatus ? html`
                        <div class="agent-kv-sub muted">${identityStatus}</div>` : nothing}
                </div>
                <div class="agent-kv">
                    <div class="label">${t("agentsDefaultLabel")}</div>
                    <div>${isDefault ? t("commonYes") : t("commonNo")}</div>
                </div>
                <div class="agent-kv">
                    <div class="label">${t("agentsIdentityEmoji")}</div>
                    <div>${identityEmoji}</div>
                </div>
                <div class="agent-kv">
                    <div class="label">${t("agentsSkillsFilter")}</div>
                    <div>${skillFilter ? `${skillCount} ${t("agentsSelected")}` : t("agentsAllSkills")}</div>
                </div>
            </div>

            <div class="agent-model-select" style="margin-top: 20px;">
                <div class="label">${t("agentsModelSelection")}</div>
                        ...
                        >
                            ${
                                    isDefault
                                            ...
                                            : html`
                                                <option value="">
                                                    ${defaultPrimary ? `${t("agentsInheritDefault")} (${defaultPrimary})` : t("agentsInheritDefault")}
                                                </option>
                                            `
                            }
                ...
                <div class="row" style="justify-content: flex-end; gap: 8px;">
                    ...
                    <button
                            ...
                            @click=${onConfigSave}
                    >
                        ${configSaving ? t("commonSaving") : t("commonSave")}
                    </button>
                </div>
            </div>
        </section>
...
function renderAgentContextCard(context: AgentContext, subtitle: string) {
    return html`
        <section class="card">
            <div class="card-title">${t("agentsAgentContext")}</div>
            <div class="card-sub">${subtitle}</div>
            <div class="agents-overview-grid" style="margin-top: 16px;">
                <div class="agent-kv">
                    <div class="label">${t("agentsWorkspace")}</div>
                ...
                <div class="agent-kv">
                    <div class="label">${t("agentsDefaultLabel")}</div>
                    <div>${context.isDefault ? t("commonYes") : t("commonNo")}</div>
                </div>
            </div>
        </section>
    `;
...
function renderAgentChannels(params: {
    ...
    const lastSuccessLabel = params.lastSuccess ? formatAgo(params.lastSuccess) : t("agentsNever");
    return html`
        <section class="grid grid-cols-2">
            ${renderAgentContextCard(context, t("agentsContextWorkspaceIdentity"))}
            <section class="card">
                <div class="row" style="justify-content: space-between;">
                    <div>
                        <div class="card-title">${t("agentsChannels")}</div>
                        <div class="card-sub">${t("agentsChannelsSub")}</div>
                    </div>
                ...
                <div class="muted" style="margin-top: 8px;">
                    ${t("agentsLastRefresh")}: ${lastSuccessLabel}
                </div>
                ${
                        params.error
                                ? html`
                                    <div class="callout danger" style="margin-top: 12px;">${params.error}</div>`
                                : nothing
                }
                ${
                        !params.snapshot
                                ? html`
                                    <div class="callout info" style="margin-top: 12px">${t("agentsLoadChannels")}</div>
                                `
                                : nothing
                }
                ${
                        entries.length === 0
                                ? html`
                                    <div class="muted" style="margin-top: 16px">${t("agentsNoChannels")}</div>
                                `
                                : html`
                                    <div class="list" style="margin-top: 16px;">
                                        ${entries.map((entry) => {
                                            ...
                                            const status = summary.total
                                                    ? `${summary.connected}/${summary.total} ${t("agentsConnected")}`
                                                    : t("agentsNoAccounts");
                                            const config = summary.configured
                                                    ? `${summary.configured} ${t("agentsConfiguredLabel")}`
                                                    : t("agentsNotConfigured");
                                            const enabled = summary.total
                                                    ? `${summary.enabled} ${t("agentsEnabled")}`
                                                    : t("agentsDisabled");
                                                        ...
                                                        ${
                                                                extras.length > 0
                                                                        ? extras.map((extra) => html`
                                                                            <div>${extra.label}: ${extra.value}</div>`)
                                                                        : nothing
                                                        }
                                                    </div>
                                                </div>
...
function renderAgentCron(params: {
    ...
    return html`
        <section class="grid grid-cols-2">
            ${renderAgentContextCard(context, t("agentsContextWorkspaceScheduling"))}
            <section class="card">
                <div class="row" style="justify-content: space-between;">
                    <div>
                        <div class="card-title">${t("agentsScheduler")}</div>
                        <div class="card-sub">${t("agentsSchedulerSub")}</div>
                    </div>
                    <button class="btn btn--sm" ?disabled=${params.loading} @click=${params.onRefresh}>
                        ${params.loading ? t("commonRefreshing") : t("commonRefresh")}
                    </button>
                ...
                <div class="stat-grid">
                    <div class="stat">
                        ...
                        <div class="stat-value">
                            ${params.status ? (params.status.enabled ? t("commonYes") : t("commonNo")) : t("commonNA")}
                        </div>
                    </div>
                    <div class="stat">
                        <div class="stat-label">${t("cronJobs")}</div>
                        <div class="stat-value">${params.status?.jobs ?? t("commonNA")}</div>
                    </div>
                    <div class="stat">
                        <div class="stat-label">${t("agentsNextWake")}</div>
        ...
        <section class="card">
            <div class="card-title">${t("agentsCronJobs")}</div>
            <div class="card-sub">${t("agentsCronJobsSub")}</div>
            ${
                    jobs.length === 0
                            ? html`
                                <div class="muted" style="margin-top: 16px">${t("agentsNoJobsAssigned")}</div>
                            `
                            : html`
                                <div class="list" style="margin-top: 16px;">
                                    ${jobs.map(
                                                ...
                                                <div class="list-item">
                                                    <div class="list-main">
                                                        ...
                                                        ${job.description ? html`
                                                            <div class="list-sub">${job.description}</div>` : nothing}
                                                        <div class="chip-row" style="margin-top: 6px;">
                                                            <span class="chip">${formatCronSchedule(job)}</span>
                                                            <span class="chip ${job.enabled ? "chip-ok" : "chip-warn"}">
                          ${job.enabled ? t("agentsEnabled") : t("agentsDisabled")}
                        </span>
...
function renderAgentFiles(params: {
    ...
    return html`
        <section class="card">
            <div class="row" style="justify-content: space-between;">
                <div>
                    <div class="card-title">${t("agentsCoreFiles")}</div>
                    <div class="card-sub">${t("agentsCoreFilesSub")}</div>
                </div>
                <button
                        class="btn btn--sm"
                ...
                >
                    ${params.agentFilesLoading ? t("commonLoading") : t("commonRefresh")}
                </button>
            </div>
            ${list ? html`
                <div class="muted mono" style="margin-top: 8px;">${t("agentsWorkspace")}: ${list.workspace}
                </div>` : nothing}
            ${
                                ...
                                <div class="agent-files-grid" style="margin-top: 16px;">
                                    <div class="agent-files-list">
                                        ${
                                                files.length === 0
                                                        ? html`
                                                            <div class="muted">${t("agentsNoFilesFound")}</div>
                                                        `
                                                        : files.map((file) =>
                                    ...
                                    <div class="agent-files-editor">
                                        ${
                                                !activeEntry
                                                        ? html`
                                                            <div class="muted">${t("agentsSelectFileToEdit")}</div>
                                                        `
                                                        : html`
                                                            <div class="agent-file-header">
                                                                ...
                                                                <div class="agent-file-actions">
                                                                    ...
                                                                    >
                                                                        ${params.agentFileSaving ? t("commonSaving") : t("commonSave")}
                                                                    </button>
                                                                </div>
                                                            </div>
                                                            ${
...
function renderAgentTools(params: {
    ...
    return html`
        <section class="card">
            <div class="row" style="justify-content: space-between;">
                <div>
                    <div class="card-title">${t("agentsToolAccess")}</div>
                    <div class="card-sub">
                        ${t("agentsToolsSubText")}
                        <span class="mono">${enabledCount}/${toolIds.length}</span> ${t("agentsEnabledCount")}
                    </div>
                </div>
                <div class="row" style="gap: 8px;">
                    ...
                    >
                        ${params.configSaving ? t("commonSaving") : t("commonSave")}
                    </button>
                </div>
            </div>
            ...
            <div class="agent-tools-meta" style="margin-top: 16px;">
                <div class="agent-kv">
                    <div class="label">${t("agentsProfile")}</div>
                    <div class="mono">${profile}</div>
                </div>
                <div class="agent-kv">
                    <div class="label">${t("agentsSource")}</div>
                ...
                ${
                        params.configDirty
                                ? html`
                                    <div class="agent-kv">
                                        <div class="label">${t("agentsStatus")}</div>
                                        <div class="mono">${t("agentsUnsaved")}</div>
                                    </div>
                                `
                                : nothing
                }
            ...
            <div class="agent-tools-presets" style="margin-top: 16px;">
                <div class="label">${t("agentsQuickPresets")}</div>
        ...
        <section class="card">
            <div class="row" style="justify-content: space-between;">
                ...
                <div class="row" style="gap: 8px;">
                    ...
                    <button class="btn btn--sm" ?disabled=${params.loading} @click=${params.onRefresh}>
                        ${params.loading ? t("commonLoading") : t("commonRefresh")}
                    </button>
                    <button
                            class="btn btn--sm primary"
                            ?disabled=${params.configSaving || !params.configDirty}
            ...
            ${
                    usingAllowlist
                            ? html`
                                <div class="callout info" style="margin-top: 12px">${t("agentsCustomAllowlist")}</div>
                            `
                            : html`
                                <div class="callout info" style="margin-top: 12px">
                                    ${t("agentsAllSkillsEnabled")}
                                </div>
                            `
            }
            ${
            ...
            ${
                    filtered.length === 0
                            ? html`
                                <div class="muted" style="margin-top: 16px">${t("agentsNoSkillsFound")}</div>
                            `
                            : html`
