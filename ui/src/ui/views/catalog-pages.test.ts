...
function skillProps(overrides: Partial<SkillLibraryProps> = {}): SkillLibraryProps {
  const skillCreate = {
    ...
    uploadTemplate: null,
    creativeScenario: "free" as const,
    creativeMessages: [],
    creativeDraft: "",
    creativeFiles: [],
    creativeInput: "",
    ...
    onClose: () => undefined,
    onChooseUpload: () => undefined,
    onChooseCreative: () => undefined,
    onUploadBack: () => undefined,
    onCreativeBack: () => undefined,
    onUploadFileChange: () => undefined,
    onUploadNext: () => undefined,
    onUploadPublish: () => undefined,
    onUploadMetaChange: () => undefined,
    onCreativeScenarioChange: () => undefined,
    onCreativeInputChange: () => undefined,
    onCreativeSend: () => undefined,
    onCreativeTestInstall: () => undefined,
    onCreativePublish: () => undefined,
    onCreativeFileSelect: () => undefined,
  };
  return {
    loading: false,
    error: null,
